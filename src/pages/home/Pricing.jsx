        ...
        <div className='text-center mb-10'>
            <label className='inline-flex items-center cursor-pointer'>
                ...
                <div className='relative'>
                    ...
                    <div className={`toggle-circle absolute left-1 top-1 w-6 h-6 bg-blue-600 rounded-full transition-transform duration-300 ${isYearly ? "transform translate-x-6" : ""}`}></div>
                </div>
            </label>
        </div>
