            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10'>
                {
                    teamMembers.map((member, index) =>(
                        <div key={member.id} className='bg-white shadow-lg rounded-lg overflow-hidden transition-all duration-300 hover:shadow-xl'>
                            ...
                            <div className='p-5 text-center'>
                                ...
                                {/* contact btm */}
                                <button className='bg-blue-600 text-white px-6 py-2 rounded-full hover:bg-blue-700 transition duration-300'>Contact {member.name.split(" ")[0]}</button>
