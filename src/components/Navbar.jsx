...
const Navbar = () => {
  return (
    <div className="navbar bg-base-100 max-w-screen-2xl container mx-auto bg-white px-5">
        ...
        <div className="navbar-end space-x-4">
            ...
            <Link to='/pricing' className="btn btn-primary bg-primary">Start Free Trial</Link>
        </div>
    </div>
  )
}
